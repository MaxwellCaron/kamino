...
import type { InventoryPermissionKey } from "@/lib/inventory-permissions"
import {
...
export function canRequestInventoryCapability(
  ...
  return canRequestInventoryPermission(permissions, getPermissionBit(permission))
}
...
export function getFolderCapabilities(
  ...
  const createFolder = getDirectInventoryCapability(
    permissions,
    "createFolder"
  )
  ...
  const deleteFolder = getDirectInventoryCapability(
    permissions,
    "deleteFolder"
  )
