...
const osTypes = [
  ...
  { label: "Solaris/OpenSolaris/OpenIndiania kernel", value: "solaris" },
]
...
export const IsoConfigurationFields = withCreateVmForm({
  ...
  render: function Render({
    ...
    const bridgeOptions: Array<NetworkOption> =
      networks?.bridges.map((bridge) => ({
        label: bridge.iface,
        value: bridge.iface,
        kind: "bridge",
      })) ?? []
    const vnetOptions: Array<NetworkOption> =
      networks?.vnets.map((vnet) => ({
        label: vnet.vnet,
        value: vnet.vnet,
        kind: "vnet",
      })) ?? []
    const networkOptions = [...bridgeOptions, ...vnetOptions]
    ...
    return (
      <div className="flex flex-col gap-6">
        ...
        <FieldSet>
          ...
          <FieldDescription>
            Select the guest OS type and the ISO that should boot the VM.
          </FieldDescription>
          <FieldGroup>
        ...
        <FieldSet>
          ...
          <FieldDescription>
            Configure the virtual CPU, firmware, and memory profile.
          </FieldDescription>
          <FieldGroup>
            <Item variant="muted">
              <ItemMedia>
              ...
              <ItemContent>
                ...
                <ItemDescription className="space-y-6 px-1">
                  <div className="grid grid-cols-2 gap-6">
            ...
            <Item variant="muted">
              ...
              <ItemContent>
                ...
                <ItemDescription className="space-y-4 px-1">
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <form.AppField name="balloon">
                      {(field) => (
                        ...
                        >
                          <FieldLabel htmlFor="iso-balloon">
                            Balloon (GB)
                          </FieldLabel>
                          <Input
                            id="iso-balloon"
                  ...
                  <p className="text-center">Set balloon to "0" to disable</p>
                </ItemDescription>
              </ItemContent>
            </Item>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <form.AppField name="disk_size">
                      {(field) => (
                        ...
                        >
                          <FieldLabel htmlFor="iso-disk-size">
                            Capacity (GB)
                          </FieldLabel>
                          <Input
                            id="iso-disk-size"
