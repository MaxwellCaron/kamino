...
export function SeriesMarkers({
  ...
  const resolvedFill = fill ?? seriesConfig.stroke
  ...
  const points = useMemo<Array<PointAt>>(
    () =>
 ...
 * hover internally; the parent doesn't re-render on cursor m.
 */
