...
function DeferredMarkdownCodeBlock(props: React.ComponentProps<"pre">) {
  return (
    <React.Suspense fallback={<MarkdownCodeBlockFallback {...props} />}>
...
export const markdownComponents: Components = {
  ...
  pre: ({ className, node: _node, ...props }) => (
    <DeferredMarkdownCodeBlock className={className} {...props} />
  ),
