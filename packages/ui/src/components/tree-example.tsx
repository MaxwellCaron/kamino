import { IconFileAi, IconFileCode, IconFileText } from "@tabler/icons-react"
import {
  TreeExpander,
  TreeIcon,
  TreeLabel,
    ...
    >
      <TreeView>
                ...
                <TreeNode level={2} nodeId="ui">
                  ...
                  <TreeNodeContent hasChildren>
                    <TreeNode level={3} nodeId="button.tsx">
                      <TreeNodeTrigger>
                        <TreeExpander />
                        <TreeIcon icon={<IconFileCode className="h-4 w-4" />} />
            ...
            <TreeNode isLast level={1} nodeId="images">
              ...
              <TreeNodeContent hasChildren>
                <TreeNode level={2} nodeId="logo.svg">
                  <TreeNodeTrigger>
                    <TreeExpander />
                    <TreeIcon icon={<IconFileText className="h-4 w-4" />} />
        ...
        <TreeNode nodeId="package.json">
          <TreeNodeTrigger>
            <TreeExpander />
            <TreeIcon icon={<IconFileAi className="h-4 w-4" />} />
